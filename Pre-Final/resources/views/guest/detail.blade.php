                                        ...
                                        <ul class="comments__list">
                                            <li class="comments__item">
                                                <div class="comments__autor">
                                                    <img class="comments__avatar" src="fontend/img/user.png"
                                                        alt="">
                                                    <span class="comments__name">John Doe</span>
                                                    <span class="comments__time">30.08.2018, 17:53</span>
                                                </div>
                                                <p class="comments__text">There are many variations of passages of
                                            ...
                                            <li class="comments__item comments__item--quote">
                                                ...
                                                <p class="comments__text"><span>There are many variations of passages
                                                        of Lorem Ipsum available, but the majority have suffered
                                                        alteration in some form, by injected humour, or randomised words
                                                        which don't look even slightly believable.</span>It has survived
                                        ...
                                        <ul class="reviews__list">
                                            <li class="reviews__item">
                                                <div class="reviews__autor">
                                                    <img class="reviews__avatar" src="fontend/img/user.png"
                                                        alt="">
                            ...
                            <div class="gallery" itemscope>
                                <div class="row">
                                    ...
                                    <figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
                                        <a href="fontend/img/gallery/project-1.jpg" itemprop="contentUrl"
                                            data-size="1920x1280">
                                            <img src="fontend/img/gallery/project-1.jpg" itemprop="thumbnail"
                                    ...
                                    <!-- gallery item -->
                                    <figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
                                        <a href="fontend/img/gallery/project-2.jpg" itemprop="contentUrl"
                                            data-size="1920x1280">
                                            <img src="fontend/img/gallery/project-2.jpg" itemprop="thumbnail"
                                                alt="Image description" />
                                        </a>
                                    ...
                                    <!-- gallery item -->
                                    <figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
                                        <a href="fontend/img/gallery/project-3.jpg" itemprop="contentUrl"
                                            data-size="1920x1280">
                                            <img src="fontend/img/gallery/project-3.jpg" itemprop="thumbnail"
                                                alt="Image description" />
                                        </a>
                                    ...
                                    <!-- gallery item -->
                                    <figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
                                        <a href="fontend/img/gallery/project-4.jpg" itemprop="contentUrl"
                                            data-size="1920x1280">
                                            <img src="fontend/img/gallery/project-4.jpg" itemprop="thumbnail"
                                                alt="Image description" />
                                        </a>
                                    ...
                                    <!-- gallery item -->
                                    <figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
                                        <a href="fontend/img/gallery/project-5.jpg" itemprop="contentUrl"
                                            data-size="1920x1280">
                                            <img src="fontend/img/gallery/project-5.jpg" itemprop="thumbnail"
                                                alt="Image description" />
                                        </a>
                                    ...
                                    <!-- gallery item -->
                                    <figure class="col-12 col-sm-6 col-xl-4" itemprop="associatedMedia" itemscope>
                                        <a href="fontend/img/gallery/project-6.jpg" itemprop="contentUrl"
                                            data-size="1920x1280">
                                            <img src="fontend/img/gallery/project-6.jpg" itemprop="thumbnail"
                                                alt="Image description" />
                                        </a>
