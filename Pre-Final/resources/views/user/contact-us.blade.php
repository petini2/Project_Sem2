                        ...
                        <div class="header__content">
                            ...
                            <ul class="header__nav">
                                ...
                                <li class="header__nav-item">
                                    <a class="header__nav-link" href="{{ url('userindex') }}">Home</a>
                                </li>
                                <!-- end dropdown -->
                                ...
                                <li class="header__nav-item">
                                    <a href="{{ url('cataloge') }}" class=" header__nav-link"
                                ...
                                <!-- dropdown -->
                                <li class="header__nav-item">
                                    <a class=" header__nav-link" href="{{ url('showbooking') }}">Show</a>
                                </li>
                                <!-- end dropdown -->

                                <!-- dropdown -->
                                <li class="header__nav-item">
                                    <a class=" header__nav-link" href="{{ url('newsandoffers') }}">News &
                                        Offers</a>
                                </li>
                                <!-- end dropdown -->
                                <li class="header__nav-item">
                                    <a class=" header__nav-link" href="{{ url('contact-us') }}">Contact us</a>
                                </li>
